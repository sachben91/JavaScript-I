...
for (let i = 0; i< inventory.length; i++){
  ...
  {
 console.log(`The car is ${inventory[i].car_year} ${inventory[i].car_make} ${inventory[i].car_model}`)
}
}
...
for (let i=0; i< inventory.length; i++)
{
lastCar = inventory.length;
if (inventory[i].id === lastCar)
{console.log(`The last car is ${inventory[i].car_make} ${inventory[i].car_model}`);}
}
